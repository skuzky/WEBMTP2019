      ...
      <div class="row">
        <div class="col s12">
          <div class="card card-2">
            ...
            <div class="col s12">
       <!--    <header>
            <h2>Nama : Bagus Muhammad Iqbal</h2>
            <h2>Nim : 1600018120</h2>
          </header> -->
          ...
          <!-- <footer> -->
            ...
            <table class="striped">
              <thead>
                <tr>
                  <th><h4>KELOMPOK MTP : '.$rows["nama_tim"].'</h3></th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <td><h5>JUDUL : '.$rows["proyek"].'</h5></td>
                </tr>
                <tr>
                  <td><h5>PEMBIMBING : '.$rows["pembimbing"].'</h5></td>
                </tr>
                <tr>
                  <td>kontak wa - '.$rows["kontak_wa"].'</td>
                </tr>
                <tr>
                  <td>anggota 1 - '.$rows["anggota_1"].'</td>
                </tr>  
                <tr> 
                  <td>anggota 2 - '.$rows["anggota_2"].'</td>
                </tr>  
                <tr>  
                  <td>anggota 3 - '.$rows["anggota_3"].'</td>
                </tr>  
                <tr>  
                  <td>anggota 4 - '.$rows["anggota_4"].'</p></td>
                </tr>
                <tr>  
                  <td>anggota 5 - '.$rows["anggota_5"].'</p></td>
                </tr>
                <tr> 
                  <td>anggota 6 - '.$rows["anggota_6"].'</td>
                </tr>
                <tr> 
                  <td>anggota 7 - '.$rows["anggota_7"].'</td>
                </tr>
               </tbody>
               <tfoot>
                 <tr>
                   <td><a class="btn btn-primary btn-small" href="uploadFile">Upload </a> <a class="btn btn-primary btn-small yellow" href="seminar">Seminar MTP</a></td>
                 </tr>
               </tfoot> 
            </table>
          </center>
